...
SequenceGroupSamplingInfo Sampler::sample_from_sequence_group(SequenceGroup::Ptr sequence_group, ov::Tensor sequence_group_logits, 
    ...
    if ((sampling_params.is_greedy_decoding() || sampling_params.is_multinomial()) && !(sampling_params.is_eagle_tree())) {
        ...
        TopKSelector* topk_searcher;
        {
            ...
            if (m_top_k_selector_info.find(request_id) == m_top_k_selector_info.end()) {
                ...
                m_top_k_selector_info.emplace(request_id, TopKSelector(sequence_group, (m_draft2target_mapping ? m_draft2target_mapping->get_tensor_view() : empty_tensor)));
            }
