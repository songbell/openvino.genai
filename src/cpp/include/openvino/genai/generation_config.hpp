...
public:
    ...
    struct TreeParams {
        // refer to eagle/model/cnets.py
        size_t branching_factor = 1; // How many leaves to expand at each node
        size_t tree_depth = 1; // How deep to look ahead, equals to the layers of tree
    } tree_params;
