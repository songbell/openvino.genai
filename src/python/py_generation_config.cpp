...
void init_generation_config(py::module_& m) {
    ...
    py::class_<GenerationConfig::TreeParams>(m, "TreeParams", "EAGLE speculative decoding parameters")
        .def(py::init<>())
    ...
    py::class_<GenerationConfig>(m, "GenerationConfig", generation_config_docstring)
        ...
        .def_readwrite("tree_params", &GenerationConfig::tree_params, "EAGLE tree parameters for speculative decoding")
