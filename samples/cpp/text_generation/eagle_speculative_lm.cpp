...
int main(int argc, char* argv[]) try {
    ...
    config.eagle_tree_params.branching_factor = 4; // Number of candidate tokens to consider at each level
    config.eagle_tree_params.tree_depth = depth; // How deep to explore the token tree
    config.eagle_tree_params.total_tokens = 15; // Total number of tokens to generate in eagle tree
